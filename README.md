...
![Watchers](https://img.shields.io/github/watchers/Priyanshu-Gupta-9165/Coursera-Automation?style=social)

![Issues](https://img.shields.io/github/issues/Priyanshu-Gupta-9165/Coursera-Automation)
![Pull Requests](https://img.shields.io/github/issues-pr/Priyanshu-Gupta-9165/Coursera-Automation)
![Contributors](https://img.shields.io/github/contributors/Priyanshu-Gupta-9165/Coursera-Automation)
![Last Commit](https://img.shields.io/github/last-commit/Priyanshu-Gupta-9165/Coursera-Automation)
![Repo Size](https://img.shields.io/github/repo-size/Priyanshu-Gupta-9165/Coursera-Automation)
![License](https://img.shields.io/github/license/Priyanshu-Gupta-9165/Coursera-Automation)
...
- **No Data Collection**: We do not collect, store, or transmit any of your personal data, course progress, or login credentials.
- **Open Source**: The full source code is available here on GitHub for transparency. you can inspect it yourself!

## 💡 Pro Tips

- **Speed Demon**: Use the speed control to watch videos at **2x** or **4x** speed. The extension ensures the setting sticks even if Coursera tries to reset it.
- **Background Run**: You can keep the Coursera tab open in the background; the extension will continue to work (ensure the browser doesn't put the tab to sleep).
- **Hard Refresh**: If something looks stuck, a simple page refresh (F5) usually fixes the automation flow instantly.

## 🛠 Troubleshooting

**Issue: Automation stopped working**
- **Fix**: Refresh the page. If that fails, click the extension icon, stop, and start again.

**Issue: "Next" button not clicking**
- **Fix**: Ensure the video has fully completed. Some courses have strict timers.
...
This project is licensed under the **MIT License**. You are free to modify and distribute it as long as you provide attribution.
...
[![Star on GitHub](https://img.shields.io/badge/⭐_Star_on_GitHub-Click_Here-gold?style=for-the-badge)](https://github.com/Priyanshu-Gupta-9165/Coursera-Automation-Extension)
...
**© 2026 Coursera Automation Extension. All rights reserved.**
